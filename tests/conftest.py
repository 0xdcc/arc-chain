...
_REAL_SUBPROCESS_TEST_FILES = frozenset(
    {
        ...
        _REPO_ROOT / "tests" / "contracts" / "test_contract_cli.py",
        _REPO_ROOT / "tests" / "contracts" / "test_import_boundary.py",
        _REPO_ROOT / "tests" / "contracts" / "test_legacy_adapter.py",
        ...
        _REPO_ROOT / "tests" / "arc_v3" / "runtime" / "test_shadow_cli.py",
        _REPO_ROOT / "tests" / "arc_v3" / "runtime" / "test_history_cli.py",
        _REPO_ROOT / "tests" / "arc_v3" / "runtime" / "test_local_audit_runner.py",
    }
)
